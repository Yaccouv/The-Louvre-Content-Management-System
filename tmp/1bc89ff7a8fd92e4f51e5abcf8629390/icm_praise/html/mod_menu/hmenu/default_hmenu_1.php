...
$menu_html = buildMenu1($mainList, $default_id, $active_id, $path, array(
        ...
        'link_class' => 'u-border-2 u-border-active-palette-4-light-1 u-border-hover-palette-1-base u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-white u-text-hover-grey-90 u-text-white',
        'link_style' => 'padding: 26px 28px;',
        'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-5c67-33',
...
$resp_menu = buildMenu1($list, $default_id, $active_id, $path, array(
        ...
        'link_style' => '',
        'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-5c67-35',
        'submenu_item_class' => 'u-nav-item',
