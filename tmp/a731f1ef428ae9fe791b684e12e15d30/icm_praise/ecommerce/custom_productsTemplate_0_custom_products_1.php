...
?>
          ...
          <a data-product-id="<?php echo $productId0; ?>" data-product="<?php echo $productJson0; ?>" href="#" class="u-border-2 u-border-grey-25 u-btn u-btn-rectangle u-button-style u-none u-product-control u-text-body-color u-btn-1 u-dialog-link u-payment-button" data-product-id=""><!--product_button_content-->Add to Cart<!--/product_button_content--></a>
        </div>
