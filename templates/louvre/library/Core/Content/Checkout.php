...
class CoreContentCheckout
{
    ...
    public function __construct($component, $componentParams)
    {
        ...
        array_push($this->_buttons, array(
            ...
            'fakeBtn' => '<button name="cancel" style="display: none;" type="reset" onclick="window.location.href=\'' . JRoute::_ ('index.php?option=com_virtuemart&view=' . $rview.'&task=cancel') . '\'"></button>',
        ));
    }
...
DATA;
        ...
        return array(
            'name' => 'userForm',
            'action' => JRoute::_('index.php?option=com_virtuemart&view=user', $this->_component->useXHTML, $this->_component->useSSL),
