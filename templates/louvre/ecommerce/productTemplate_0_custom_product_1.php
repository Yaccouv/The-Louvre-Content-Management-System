<section class="u-align-center u-clearfix u-section-1" id="sec-0568">
...
c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"></path></svg>
        ...
        <?php $addZeroCents = true ?><div class="u-product-control u-product-price u-product-price-1">
          <div class="u-price-wrapper u-spacing-10"><!--product_old_price-->
            <?php if ($productOldPrice0): ?><div class="u-hide-price u-old-price" style="text-decoration: line-through !important;"><?php echo addZeroCentsProcess($productOldPrice0, $addZeroCents); ?></div><?php endif; ?><!--/product_old_price--><!--product_regular_price-->
            <?php if ($productRegularPrice0): ?><div class="u-price u-text-palette-2-base" style="font-size: 1.875rem; font-weight: 700;"><?php echo addZeroCentsProcess($productRegularPrice0, $addZeroCents); ?></div><?php endif; ?><!--/product_regular_price-->
          </div>
...
?>
        ...
        <a data-product-id="<?php echo $productId0; ?>" data-product="<?php echo $productJson0; ?>" href="#" class="u-border-2 u-border-black u-btn u-button-style u-hover-black u-none u-product-control u-text-black u-text-hover-white u-btn-1 u-dialog-link u-payment-button" data-product-button-click-type="go-to-page"><!--product_button_content-->Add to Cart<!--/product_button_content--></a>
      </div>
