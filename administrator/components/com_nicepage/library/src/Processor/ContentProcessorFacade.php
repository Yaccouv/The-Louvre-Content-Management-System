...
class ContentProcessorFacade
{
    ...
    private $_settings;
    private $_propsId;
    private $_siteProduct;
    private $_siteProducts;
    ...
    public function __construct($options = array())
    {
        ...
        $this->_siteProduct = isset($options['siteProduct']) ? $options['siteProduct'] : '';
        $this->_siteProducts = isset($options['siteProducts']) ? $options['siteProducts'] : '';
    }
    ...
    public function process($content)
    {
        ...
        if ($this->_isPulic) {
            ...
            $products = new ProductsProcessor($this->_pageId, $this->_siteProduct, $this->_siteProducts);
